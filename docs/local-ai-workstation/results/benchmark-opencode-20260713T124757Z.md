...
Generated: 20260713T124757Z UTC
Agent: opencode
Model: qwen3.6:35b-a3b-nvfp4
Default context target: 64K when supported
Status: completed
Exit code: 0
Elapsed wall seconds: 36
Raw output: benchmark-opencode-20260713T124757Z.raw.txt
...
Benchmark workspace: /Users/iskaypet/code/no-work/tools/local-agentic-dev/docs/local-ai-workstation/results/benchmark-workspaces/opencode-20260713T124757Z
...
The Aider command uses --yes-always only inside the copied benchmark workspace to prevent non-interactive TTY prompts from breaking measurement.
